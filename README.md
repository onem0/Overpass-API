...
* `OVERPASS_MAX_SIZE` - set the maximum size for queries (default: 1M). Translates to nginx [`client_max_body_size`](https://nginx.org/en/docs/http/ngx_http_core_module.html#client_max_body_size).
